  ...
  return (
    <section className="terminal-card hover-panel p-4">
      ...
      <div className="mt-3 space-y-2 text-xs text-[var(--color-subtext1)]">
        <a
          className="flex items-center justify-between rounded-md border border-[var(--color-surface1)] px-3 py-2 text-[var(--color-text)] transition hover:border-[var(--color-accent)]"
