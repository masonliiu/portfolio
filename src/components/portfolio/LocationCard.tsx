export default function LocationCard() {
  return (
    <section className="terminal-card hover-panel p-4">
      ...
      <div className="mt-2 overflow-hidden rounded-lg border border-[var(--color-surface1)] bg-[var(--color-mantle)]">
      ...
      <div className="mt-2 text-xs text-[var(--color-subtext1)]">Dallas, TX</div>
    </section>
  );
}
